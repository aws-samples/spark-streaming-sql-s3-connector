...
trait AsyncClientBuilder[T] {
  def sourceOptions(options: S3ConnectorSourceOptions): AsyncClientBuilder[T]
  def consumer(function: FileMetadata[T] => Unit): AsyncClientBuilder[T]
